...
transaction_feature_df_train <- transaction_feature_function(transaction_df = training_transactions_final , accounts_df = training_accounts_final)
...
undirected_weighted_graph_raw_train <- graph_from_data_frame(d = training_transactions_final,
                                                       directed = F,
                                                       vertices = training_accounts_final) 
...
weight_ind <- which(names(training_transactions_final) == 'weight')

directed_graph_train <- graph_from_data_frame(d = training_transactions_final[,-weight_ind],
                                       directed = T,
                                       vertices = training_accounts_final)
...
### NBNB!!! FOR LOOP SHOULD BE ADDED ##### - Continue here!
