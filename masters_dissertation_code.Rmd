...
### EDA of testing and training sets ###

```{r,  eda of testing and training sets}

plot_boxplot(train_all_features, by = "is_fraud")

plot_boxplot(test_all_features, by = "is_fraud")
