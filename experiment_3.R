...
# Description/Goal of experiment: To investigate what the effect would be if dropout regularization is applied.

# 1. Defining Flags we are going to use

FLAGS <- flags(flag_integer('dense_units', 8),
               flag_integer('batch_size', 80),
               flag_integer('epochs', 16),
